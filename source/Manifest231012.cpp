...
namespace ParameterPile
{
	...
	{
		std::cout << "Initializing TEST 231012 manifests..." << std::endl;
#define PAIR std::pair<double, double>
		...
		default_exp_manifest.in_folder = "../hdda/Data/231012/";
		default_exp_manifest.out_folder = "../hdda/Data/231012/results_vt/";
		...
		if (!read_accepted_events(default_exp_manifest.accepted_events_fname, default_exp_manifest.accepted_events_data)) {
			std::cout << "Init231012_tests:: No event selection - processing everything" << std::endl;
		...
		default_exp_manifest.out_gnuplot_folder = "../Data/231012/results_vt/gnuplot/";
		...
		//default_exp_manifest.runs.push(370, 380); //f27 923V
		//default_exp_manifest.runs.push(352, 368); //f26 877V
		//default_exp_manifest.runs.push(334, 349); //f24 831V
		//default_exp_manifest.runs.push(317, 332); //f23 785V
		//default_exp_manifest.runs.push(301, 315); //f22 739V
		//default_exp_manifest.runs.push(284, 299); //f21 693V
		//default_exp_manifest.runs.push(268, 282); //f20 646V
		//default_exp_manifest.runs.push(252, 266); //f19 600V
		//default_exp_manifest.runs.push(236, 250); //f18 554V
		//default_exp_manifest.runs.push(220, 234); //f17 508V
		//default_exp_manifest.runs.push(203, 218); //f16 462V
		//default_exp_manifest.runs.push(187, 201); //f15 416V
		//default_exp_manifest.runs.push(170, 185); //f14 369V
		//default_exp_manifest.runs.push(154, 168); //f13 323V
		//default_exp_manifest.runs.push(133, 152); //f12 277V
		//default_exp_manifest.runs.push(112, 131); //f11 231V
		//default_exp_manifest.runs.push(91, 110); //f10 185V
		//default_exp_manifest.runs.push(48, 89); //f9 0V

		default_exp_manifest.runs.push(370, 370);
		...
		//ALL PARAMETERS (THRESHOLDS) ARE THE SAME FOR ALL FOLDERS FOR 231012 DATA!
		//default_exp_manifest.channels.info(3)->baseline.do_find_curved = false;
		experiment_manifest new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_923V_850V_46V_no_coll") + "/");
		...
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_877V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_831V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_785V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_739V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_693V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_646V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_600V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_554V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_508V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_462V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_416V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_369V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_323V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_277V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_231V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_185V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_S2_LArN2_10kV_0V_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

#undef PAIR
		for (std::size_t m = 0, m_end_ = manifest.manifests.size(); m != m_end_; ++m)
			manifest.manifests[m].channels.sort();
		std::cout << "Loaded TEST 231012 manifests" << std::endl;
		return true;
	}
	...
	{
		std::cout << "Initializing 231012 manifests..." << std::endl;
#define PAIR std::pair<double, double>
		area_vector SiPM_channels;
		SiPM_channels.push(32, 43);
		SiPM_channels.push(48, 59);
		...
		default_exp_manifest.data_voltage_of_zero_channel = -1.0;
		default_exp_manifest.in_folder = "../hdda/Data/231012/";
		default_exp_manifest.out_folder = "../hdda/Data/231012/results_v1/";
		default_exp_manifest.write_event_indices = false;
		default_exp_manifest.accepted_events_fname = "";
		if (!read_accepted_events(default_exp_manifest.accepted_events_fname, default_exp_manifest.accepted_events_data)) {
			std::cout << "Init231012:: No event selection - processing everything" << std::endl;
			default_exp_manifest.accepted_events_data.clear();
		}
		default_exp_manifest.subruns_per_file = 1000;
		default_exp_manifest.runs_to_draw.push(0, 9999); //DRAW all
...
#undef PAIR
		for (std::size_t m = 0, m_end_ = manifest.manifests.size(); m != m_end_; ++m)
			manifest.manifests[m].channels.sort();
		std::cout << "Loaded 231012 manifests" << std::endl;
		return true;
	}
	...
	{
		std::cout << "Initializing charge 231012 manifests..." << std::endl;
...
#define PAIR std::pair<double, double>
		...
		default_exp_manifest.accepted_events_fname = "";
		if (!read_accepted_events(default_exp_manifest.accepted_events_fname, default_exp_manifest.accepted_events_data)) {
			std::cout << "Init231012_Q:: No event selection - processing everything" << std::endl;
			default_exp_manifest.accepted_events_data.clear();
		}
		default_exp_manifest.subruns_per_file = 1000;
		default_exp_manifest.runs_to_draw.push(0, 9999); //DRAW all
		...
		//MODIFY ONLY THIS BLOCK AND DISPLAY-RELATED VALUES FOR CHANNELS
		default_exp_manifest.out_gnuplot_folder = "../hdda/Data/231012/results_v1/gnuplot/";
		default_exp_manifest.out_picture_folder = "";
		default_exp_manifest.draw_only = false; //if set to true, no data is written to output
		default_exp_manifest.runs.push(0, 9999); //Use only when all invalid files are deleted from folders.
		default_exp_manifest.sub_runs.push(0, default_exp_manifest.subruns_per_file - 1);
		...
		//ALL PARAMETERS (THRESHOLDS) ARE THE SAME FOR ALL FOLDERS FOR 231012 DATA!
		experiment_manifest new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_Q_20kV_850V_46V_no_coll") + "/");
		//this is a place to tweak individual channel for specific fields
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_Q_18kV_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_Q_16kV_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_Q_14kV_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_Q_12kV_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_Q_10kV_850V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);

		new_manifest = default_exp_manifest;
		new_manifest.append_folder((new_manifest.name = "231012_X-ray_Q_8kV_800V_46V_no_coll") + "/");
		manifest.manifests.push_back(new_manifest);
#undef PAIR
		for (std::size_t m = 0, m_end_ = manifest.manifests.size(); m != m_end_; ++m)
			manifest.manifests[m].channels.sort();
		std::cout << "Loaded charge 231012 manifests" << std::endl;
		return true;
	}
};
