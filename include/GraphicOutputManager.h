...
protected:
	...
	std::vector<std::string> _data_fnames;
...
public:
	...
	void AddToDraw(std::vector<double> xs, std::vector<double> ys, std::string title="", std::string extra_txt ="", int pad_index=0);
